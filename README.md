...
これは、「日本言語地図データベース（LAJDB）」のデータを可視化するインタラクティブな Web アプリケーションです。
...
本アプリケーションのプログラムコード（HTML, JavaScript, CSS等）は [MIT License](https://opensource.org/licenses/MIT) の下で公開されています。  
